...
def main():
 ...
 code=(ROOT/"versioning/contract.py").read_text()
 ...
 (ROOT/"deployments/studio.json").parent.mkdir(parents=True,exist_ok=True)
 (ROOT/"deployments/studio.json").write_text(json.dumps(out,indent=2))
